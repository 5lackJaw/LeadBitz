...
type CampaignSequencePageProps = {
  params: Promise<{ campaignId: string }>;
};

export default async function CampaignSequencePage({ params }: CampaignSequencePageProps) {
    ...
    <main className="lb-page">
      <section className="lb-container">
        <header className="lb-row">
          <div>
            <h1 className="lb-title">Sequence</h1>
        ...
        <section className="lb-panel">
          <p className="lb-subtitle">
            Sequence builder controls remain the next implementation milestone.
          </p>
        </section>
      </section>
    </main>
